...
class AddressManager implements CommonManager {
  ...
  _buildAddressName(row: {
    ...
    const getNameByMatchId = R.useWith(
      ...
      /* eslint-disable */
      R.curry((data, code) =>
        R.prop(// @ts-ignore: ramda
          "name",// @ts-ignore: ramda
          R.find((d) => R.startsWith(code, R.prop("code", d)))(data)
        )
      ),
  ...
  _getChineseList(id?: number): ManagerResponse<any> {
    ...
    return new ManagerResponseSuccess({
      msg: responseMsg.ADDRESS_ALL_LIST_SUCCESS,
      data: result,
    });
  }
  _getCityList(id?: number): ManagerResponse<any> {
    ...
    return new ManagerResponseSuccess({
      msg: responseMsg.CITY_LIST_SUCCESS,
      data: result,
    });
  }
  _getAreaList(id?: number): ManagerResponse<any> {
    ...
    return new ManagerResponseSuccess({
      msg: responseMsg.AREA_LIST_SUCCESS,
      data: result,
    });
  }
  _getProvinceList(id?: number): ManagerResponse<any> {
    ...
    return new ManagerResponseSuccess({
      msg: responseMsg.PROVINCE_LIST_SUCCESS,
      data: result,
    });
  }
  _getTownList(id?: number): ManagerResponse<any> {
    ...
    return new ManagerResponseSuccess({
      msg: responseMsg.TOWN_LIST_SUCCESS,
      data: result,
    });
  }
}
